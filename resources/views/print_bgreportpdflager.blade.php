...
<p><b Bills Status as on : <?php echo date('d-m-Y'); ?></b></p>
    ...
    <table>  
     ...
     <input class="button-20" type="button" onclick="location.href='https://wholesale.veepeeonline.com/api/v1/bgreportpdfdownload?user_id=<?php echo $user_id;?>&user_type=<?php echo $user_type; ?>&clbal=<?php echo $clbal;?>';" value="Download PDF" /> 
     <!-- HTML !-->
