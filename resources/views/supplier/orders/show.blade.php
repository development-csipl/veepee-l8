        ...
        <table width="800" border="0" cellpadding="0" cellspacing="0" style="font-family:arial; border:1px solid #ddd;margin-left: auto;margin-right: auto;">
            <tr>
                <td width="800" align="center" valign="middle" style="background-color:#9191be;padding:1%">
                    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" style="text-align:center;">
                        ...
                        <tr>
                            <td height="20" style="font-family:arial; font-size:12px; color:#ffffff;">IX/1604 - A, Krishna Market, Patel Gali , Near Ekta Bakery , Gandhi Nagar , Delhi - 110031</td>
                        </tr>
                        <tr>
           ...
           <tr>    
            ...
            <tr>    
                ...
                <tr>
                     <th width="100%" colspan="4" align="left" style="border:1px solid #ddd; font-family:arial; font-size:12px; line-height:20px; padding:5px 10px; font-weight:600;">REMARK</th>
                </tr>
                <tr>
                    <td width="100%" colspan="4">
                        <div style="width:100%;">
                                <div style="width:33.3%; float:left; border-left:1px solid #ddd; font-family:arial; font-size:12px; line-height:20px; padding:5px 10px; font-weight:400;">{{$data->order->remark ?? ''}}</div>
                        </div>
                    </td>
                </tr>
