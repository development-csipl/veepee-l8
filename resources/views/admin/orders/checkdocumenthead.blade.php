    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="col-md-12 form-group {{ $errors->has('supplier_invoice') ? 'has-error' : '' }}">
                ...
                <input type="text" id="supplier_invoice" name="supplier_invoice" class="form-control" value="{{ @old('supplier_invoice') ?? @$delivery->supplier_invoice }}" required disabled>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12 form-group {{ $errors->has('supplier_firm_status') ? 'has-error' : '' }}">
                ...
                <select id="case_status" name="status" class="form-control" required>
            ...
            <div class="col-md-12 form-group" id="reject_reason_show">
