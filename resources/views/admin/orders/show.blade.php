                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <table width="100%">
                                                        ...
                                                        <?php if (array_key_exists("ordertracking",(array)$orders)) { ?>
                                                ...
                                                @if($orders->orderdelivery->isNotEmpty())
                                                    @foreach($orders->orderdelivery as $row)
                                                        <tr>
                                                            ...
                                                            <td><?php if($row->invoice == ''){echo 'No';} else { echo '<a href="'.url("images/order_request/".$row->invoice).'" target="_blank">Yes</a>';} ?> </td>
