        ...
        <form action="{{ route("admin.transports.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('branch_id') ? 'has-error' : '' }}">
             ...
             <div class="form-group {{ $errors->has('transport_name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="transport_name" name="transport_name" value="{{@old('transport_name')}}" class="form-control" required>
             ...
             <div class="form-group {{ $errors->has('gst') ? 'has-error' : '' }}">
                ...
                <input type="text" id="gst" name="gst" value="{{@old('gst')}}" maxlength="15" class="form-control" required>
                @if($errors->has('gst'))
                    <p class="help-block">
                        {{ $errors->first('gst') }}
                    </p>
             ...
             <div class="form-group {{ $errors->has('contact_person') ? 'has-error' : '' }}">
                ...
                <input type="text" id="contact_person" name="contact_person" value="{{@old('contact_person')}}" class="form-control" required>
             ...
             <div class="form-group {{ $errors->has('contact_mobile') ? 'has-error' : '' }}">
                ...
                <input type="text" id="contact_mobile" name="contact_mobile" value="{{@old('contact_mobile')}}" class="form-control" required>
