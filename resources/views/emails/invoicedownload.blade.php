           ...
           <tr>    
                <td style=" font-family:arial; font-size:16px; line-height:24px; color:#000; font-weight:400;">
                    <table width="800" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #ddd">
                	    <tbody>
                    		<tr>
                    			<td width="600" style="font-family:arial; font-size:14px; padding:5px 10px; line-height:24px; color:#000; font-weight:400;">We are writing to let you know that your order no. is {{$data->order->vporder_id ?? ''}}, has been {{$data->order->status }}.</td>
            ...
            <tr>    
                ...
                <tr>
                    ...
                    <th style="border:1px solid #ddd; font-family:arial; font-size:12px; padding:5px 10px; font-weight:400;">BILTY RECEIVED LAST DATE </th>
                    ...
                    <td width="100%" colspan="4">
                        <div style="width:100%;">
                            @foreach($data->items as $item)
                                <div style="width:33.3%; float:left; border-left:1px solid #ddd; font-family:arial; font-size:12px; line-height:20px; padding:5px 10px; font-weight:400;">{{$item['name']}}/{{$item['category']}}/{{$item['season']}}</div>
                            @endforeach
                        </div>
                    </td>
                </tr>
                        ...
                        <tbody>                    
                        	...
                        	<tr>
                        		<td style=" font-family:arial; font-size:14px; padding:5px 10px; font-weight:400;">
                        			<p style="font-family:arial; font-size:14px; line-height:24px; margin:0; font-weight:400;">1. Bill and Bilty should be deposited at our office before due date.</p>
                                    ...
                                    <p style="font-family:arial; font-size:14px; line-height:24px; margin:5px 0 0 0; font-weight:400;">7. For any enquiry call 07718277182 (Office Time - 10:00 AM to 6:00 PM)</p>
                        		</td>
                        	</tr>
                    	</tbody>
                    </table>
