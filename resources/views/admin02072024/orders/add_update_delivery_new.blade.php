...
<div class="card">
    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data" onsubmit="disableButton()">
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-12 form-group {{ $errors->has('invoice') ? 'has-error' : '' }}">
                <label for="invoice">Veepee Invoice*</label>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12 form-group {{ $errors->has('bo_amount') ? 'has-error' : '' }}">
                ...
                <input type="text" id="bo_amount" name="bo_amount" class="form-control" value="{{ @old('bo_amount') ?? @$delivery->bo_amount }}" readonly>
            ...
            <div class="col-md-12 form-group {{ $errors->has('bo_case_number') ? 'has-error' : '' }}">
                ...
                <input type="text" id="bo_case_number" name="bo_case_number" class="form-control" value="{{ @old('bo_case_number') ?? @$delivery->bo_case_number }}" readonly>
           ...
           <div class="col-md-12 form-group {{ $errors->has('supplier_invoice') ? 'has-error' : '' }}">
                ...
                <input type="text" id="supplier_invoice" name="supplier_invoice" class="form-control" value="{{ @old('supplier_invoice') ?? @$delivery->supplier_invoice }}" readonly>
            ...
            <div class="col-md-12 form-group {{ $errors->has('veepee_invoice_number') ? 'has-error' : '' }}">
                ...
                <input type="text" id="veepee_invoice_number" name="veepee_invoice_number" class="form-control" value="{{ @old('veepee_invoice_number') ?? @$delivery->veepee_invoice_number }}" readonly>
        ...
        @endif
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input class="btn btn-primary" type="submit" id="submit-button" value="{{ trans('global.save') }}">
