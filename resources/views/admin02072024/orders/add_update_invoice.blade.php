    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <input type="file" id="order_form" name="order_form" class="form-control" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('supplier_bill') ? 'has-error' : '' }}">
                ...
                <input type="file" id="supplier_bill" name="supplier_bill" class="form-control" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('transport_bill') ? 'has-error' : '' }}">
                ...
                <input type="file" id="transport_bill" name="transport_bill" class="form-control" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('eway_bill') ? 'has-error' : '' }}">
                ...
                <input type="file" id="eway_bill" name="eway_bill" class="form-control" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('credit_note') ? 'has-error' : '' }}">
                ...
                <input type="file" id="credit_note" name="credit_note" class="form-control" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('debit_note') ? 'has-error' : '' }}">
                ...
                <input type="file" id="debit_note" name="debit_note" class="form-control" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('bo_amount') ? 'has-error' : '' }}">
                ...
                <input type="text" id="bo_amount" name="bo_amount" class="form-control" value="{{ @old('bo_amount') ?? @$delivery->bo_amount }}" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('bo_case_number') ? 'has-error' : '' }}">
                ...
                <input type="text" id="bo_case_number" name="bo_case_number" class="form-control" value="{{ @old('bo_case_number') ?? @$delivery->bo_case_number }}" disabled>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12 form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                ...
                <input type="text" id="price" name="price" class="form-control" value="{{ @old('price') ?? @$delivery->price }}" disabled>
                @if($errors->has('price'))
                    <p class="help-block">
                        {{ $errors->first('price') }}
                    </p>
            ...
            <div class="col-md-12 form-group {{ $errors->has('no_of_case') ? 'has-error' : '' }}">
                ...
                <input type="text" id="no_of_case" name="no_of_case" class="form-control" value="{{ @old('no_of_case') ?? @$delivery->no_of_case }}" disabled>
            ...
            <div class="col-md-12 form-group {{ $errors->has('veepee_invoice_number') ? 'has-error' : '' }}">
                ...
                <input type="text" id="veepee_invoice_number" name="veepee_invoice_number" class="form-control" value="{{ @old('veepee_invoice_number') ?? @$delivery->veepee_invoice_number }}" required>
