            ...
            <div class="row">
                ...
                <div class="col-md-2"> 
                    <div class="form-group {{ $errors->has('order_by') ? 'has-error' : '' }}" style="padding-top: 40px;">
                        <input type="radio" id="option1" name="order_by" value="Self (Online)" {{($order->order_by=='Self (Online)')?'checked':''}}>
                        <label for="option1">Self (Online)</label>
                    </div>
                </div>
                <div class="col-md-3"> 
                    <div class="form-group {{ $errors->has('order_by') ? 'has-error' : '' }}" style="padding-top: 40px;"> 
                        <input type="radio" id="option2" name="order_by" value="VP Branch (Branch Visit)" {{($order->order_by=='VP Branch (Branch Visit)')?'checked':''}}>
