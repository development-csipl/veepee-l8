...
class ProductCategoryController extends Controller
{
    ...
    public function create()
    {
		...
		//DB::enableQueryLog();
		$parentcategory = ProductCategory::where('parent_id','=',0)->get();
		//dd(DB::getQueryLog());
		return view('admin.productCategories.create',compact('parentcategory'));
    }
    ...
    public function edit(ProductCategory $productCategory)
    {
        ...
        return view('admin.productCategories.edit', compact('productCategory','parentcategory'));
    }
